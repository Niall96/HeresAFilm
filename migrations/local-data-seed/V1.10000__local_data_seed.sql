INSERT INTO public.users (id, email_address, username, user_password , date_of_birth, created) VALUES 
...
INSERT INTO public.user_films (id,user_id, film) VALUES 
(1,1, '{{1,1}, {2,2}, {4,3}, {5,1}, {3,2}, {8,1}}'),
(2,2, '{{1,3}, {9,2}, {4,3}, {8,1}, {3,2}, {8,1}}');
